...
def twitter(request):
    ...
    if request.GET.get('tweet', False) is not False:
        ...
        if tweet is not '':
            # authenicate API
            CONSUMER_KEY = '6n8XQfl8q1axFNHBxs1PlGhxE'
            CONSUMER_SECRET = 'kNZMIpQ5myOLU6hlRZWvdClFR7vyMa5Ng4Iq0Snxe920hSfm9G'
            ACCESS_TOKEN = '2879894589-6ZDwAJnO2PtyCd5TB03OYV1XjJKL0DWsWpKziXU'
            ACCESS_TOKEN_SECRET = 'BFSIoEIRT794YpbsSlrfgCGIK4zgdzK5DNMGow041PMbI'
